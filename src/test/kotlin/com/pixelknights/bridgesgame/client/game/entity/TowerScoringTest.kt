...
class TowerScoringTest {
    ...
    private val basePositions = mapOf(
        ...
        GameColor.MAGENTA to (0 to 9),
        GameColor.CYAN to (5 to 11),
    ...
    fun `red adjacent colors score 1`() {
        ...
        assertEquals(1, scoring.getCapturePoints(GameColor.RED, GameColor.MAGENTA))
    ...
    fun `red far colors score 2`() {
        ...
        assertEquals(2, scoring.getCapturePoints(GameColor.RED, GameColor.CYAN))
    ...
    fun `cyan opposite color scores 3`() {
        ...
        assertEquals(3, scoring.getCapturePoints(GameColor.CYAN, GameColor.ORANGE))
    }
